...
void main() {
  group('Test ChargerSpot Class', () {
    test('JSONのデコード', () {
      ...
      expect(chargerSpots[0].chargerSpotServiceTimes![0].startTime,
          equals("00:00"));
      expect(
          chargerSpots[0].chargerSpotServiceTimes![0].endTime, equals("24:00"));
      expect(chargerSpots[0].chargerSpotServiceTimes![0].businessDay,
          equals("yes"));
      ...
      expect(
          chargerSpots[0].chargerDevices![0].displayStatus, equals("no_info"));
