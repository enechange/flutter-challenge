...
class ChargerSpotsApi {
  ...
  Future<Response<OpenApi.Response>> chargerSpots({
    ...
    final _queryParameters = <String, dynamic>{
      if (userUuid != null)
        r'user_uuid': encodeQueryParameter(
            _serializers, userUuid, const FullType(String)),
      if (swLat != null)
        r'sw_lat':
            encodeQueryParameter(_serializers, swLat, const FullType(String)),
      if (swLng != null)
        r'sw_lng':
            encodeQueryParameter(_serializers, swLng, const FullType(String)),
      if (neLat != null)
        r'ne_lat':
            encodeQueryParameter(_serializers, neLat, const FullType(String)),
      if (neLng != null)
        r'ne_lng':
            encodeQueryParameter(_serializers, neLng, const FullType(String)),
      if (uuid != null)
        r'uuid':
      ...
      if (fields != null)
        r'fields':
            encodeQueryParameter(_serializers, fields, const FullType(String)),
      if (deviceTypes != null)
        r'device_types': encodeQueryParameter(
            _serializers, deviceTypes, const FullType(String)),
      if (feeTypes != null)
        r'fee_types': encodeQueryParameter(
            _serializers, feeTypes, const FullType(String)),
      if (nowAvailable != null)
        r'now_available': encodeQueryParameter(
            _serializers, nowAvailable, const FullType(String)),
      if (styles != null)
        r'styles':
            encodeQueryParameter(_serializers, styles, const FullType(String)),
      if (gogoevAuthenticationNetworks != null)
        r'gogoev_authentication_networks': encodeQueryParameter(
            _serializers, gogoevAuthenticationNetworks, const FullType(String)),
      if (categories != null)
        r'categories': encodeQueryParameter(
            _serializers, categories, const FullType(String)),
      if (open24Hours != null)
        r'open_24_hours': encodeQueryParameter(
            _serializers, open24Hours, const FullType(String)),
      if (advanceContacts != null)
        r'advance_contacts': encodeQueryParameter(
            _serializers, advanceContacts, const FullType(String)),
      if (parkingFeeTypes != null)
        r'parking_fee_types': encodeQueryParameter(
            _serializers, parkingFeeTypes, const FullType(String)),
    };
    ...
    try {
      const _responseType = FullType(OpenApi.Response);
