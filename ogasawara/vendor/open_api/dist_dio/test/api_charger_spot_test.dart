...
void main() {
  final instance = APIChargerSpotBuilder();
  // TODO add properties to the builder and call build()

  group(APIChargerSpot, () {
    ...
    // BuiltList<APIChargerSpotImage> images
    ...
    // BuiltList<APIGroupedTotalUnitPricesThisMonthNextMonth> groupedTotalUnitPricesThisMonthNextMonth
    ...
    // BuiltList<APIGroupedTotalUnitPricesThisMonthNextMonthByUser> groupedTotalUnitPricesThisMonthNextMonthByUser
    ...
    // BuiltList<APIChargerSpotServiceTime> chargerSpotServiceTimes
    test('to test the property `chargerSpotServiceTimes`', () async {
      // TODO
    });

    // 充電器情報
    // BuiltList<APIChargerDevice> chargerDevices
    test('to test the property `chargerDevices`', () async {
      // TODO
    });

    // Gogoevの充電器情報（Gogoevの充電器のみ、fields指定がない場合は返却される）
    // BuiltList<APIGogoevChargerDevice> gogoevChargerDevices
