...
@BuiltValue()
abstract class ChargerDevice implements Built<ChargerDevice, ChargerDeviceBuilder> {
  /// 充電器の名称
  ...
  ChargerDeviceDisplayStatusEnum get displayStatus;
  ...
  factory ChargerDevice([void updates(ChargerDeviceBuilder b)]) = _$ChargerDevice;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ChargerDeviceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ChargerDevice> get serializer => _$ChargerDeviceSerializer();
}

class _$ChargerDeviceSerializer implements PrimitiveSerializer<ChargerDevice> {
  @override
  final Iterable<Type> types = const [ChargerDevice, _$ChargerDevice];

  @override
  final String wireName = r'ChargerDevice';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ChargerDevice object, {
    ...
    yield serializers.serialize(
      ...
      specifiedType: const FullType(ChargerDeviceDisplayStatusEnum),
    );
    yield r'power';
    yield serializers.serialize(
      object.power,
  ...
  void _deserializeProperties(
    ...
    required ChargerDeviceBuilder result,
      ...
      switch (key) {
        ...
        case r'display_status':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(ChargerDeviceDisplayStatusEnum),
          ) as ChargerDeviceDisplayStatusEnum;
  ...
  @override
  ChargerDevice deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ChargerDeviceBuilder();
...
class ChargerDeviceDisplayStatusEnum extends EnumClass {

  /// 表示用ステータス（unavailable_or_no_info: 利用不可または情報なし, in_use: 利用中, available: 利用可能, unable_to_obtain_info: 情報取得不可（gogoevなど）
  @BuiltValueEnumConst(wireName: r'unavailable_or_no_info')
  static const ChargerDeviceDisplayStatusEnum unavailableOrNoInfo = _$chargerDeviceDisplayStatusEnum_unavailableOrNoInfo;
  /// 表示用ステータス（unavailable_or_no_info: 利用不可または情報なし, in_use: 利用中, available: 利用可能, unable_to_obtain_info: 情報取得不可（gogoevなど）
  @BuiltValueEnumConst(wireName: r'in_use')
  static const ChargerDeviceDisplayStatusEnum inUse = _$chargerDeviceDisplayStatusEnum_inUse;
  /// 表示用ステータス（unavailable_or_no_info: 利用不可または情報なし, in_use: 利用中, available: 利用可能, unable_to_obtain_info: 情報取得不可（gogoevなど）
  @BuiltValueEnumConst(wireName: r'available')
  static const ChargerDeviceDisplayStatusEnum available = _$chargerDeviceDisplayStatusEnum_available;
  /// 表示用ステータス（unavailable_or_no_info: 利用不可または情報なし, in_use: 利用中, available: 利用可能, unable_to_obtain_info: 情報取得不可（gogoevなど）
  @BuiltValueEnumConst(wireName: r'unable_to_obtain_info')
  static const ChargerDeviceDisplayStatusEnum unableToObtainInfo = _$chargerDeviceDisplayStatusEnum_unableToObtainInfo;

  static Serializer<ChargerDeviceDisplayStatusEnum> get serializer => _$chargerDeviceDisplayStatusEnumSerializer;

  const ChargerDeviceDisplayStatusEnum._(String name): super(name);

  static BuiltSet<ChargerDeviceDisplayStatusEnum> get values => _$chargerDeviceDisplayStatusEnumValues;
  static ChargerDeviceDisplayStatusEnum valueOf(String name) => _$chargerDeviceDisplayStatusEnumValueOf(name);
}
